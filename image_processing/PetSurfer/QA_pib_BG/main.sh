...
cp -r /home1/jasonkru/atri_code/processors/PetSurfer/QA_pib_BG /home1/jasonkru/temp_code/
...
# Count the number of subjects (non-empty lines) in the file
