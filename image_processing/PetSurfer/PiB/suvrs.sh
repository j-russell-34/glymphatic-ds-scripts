...
--targ "${SUBJECTS_PET_DIR}/${SUBJECT_ID}/gtmpvc.output/rbv.long.nii.gz" \
--regheader \
...
mri_segstats --seg "${SUBJECTS_PET_DIR}/${SUBJECT_ID}/basal_ganglia.nii.gz" --id 1 --i "${SUBJECTS_PET_DIR}/${SUBJECT_ID}/gtmpvc.output/rbv.long.nii.gz" --avgwf "${SUBJECTS_PET_DIR}/${SUBJECT_ID}/basal_ganglia_stats.txt"
