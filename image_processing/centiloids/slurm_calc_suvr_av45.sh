...
#SBATCH --job-name=centiloids_av45
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --mem-per-cpu=16G
#SBATCH --time=00:30:00
#SBATCH --output=logs/centav45_%j.log

#Study specific variables
STUDY="ABCDS"

# Check if subject list exists
SUBJECT_LIST_FILE="/project2/jasonkru_1564/studies/${STUDY}/centiloid_fbp_subject_list.txt"
...
apptainer exec \
    ...
    "$CONTAINER" \
    python /data/scripts/av45_centiloid_calc.py
