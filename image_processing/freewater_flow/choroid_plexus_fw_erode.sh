...
--match 31 63 \
--erode 1 \
--o ${SUBJECTS_BASE_DIR}/${SUBJECT}/Register_Freesurfer/brain_choroid_plexus_erode_roi.nii.gz
...
mri_segstats \
--seg ${SUBJECTS_BASE_DIR}/${SUBJECT}/Register_Freesurfer/brain_choroid_plexus_erode_roi.nii.gz \
--id 1 \
--i "$FW_IMAGE" \
--avgwf ${SUBJECTS_FW_DIR}/${SUBJECT}/Compute_FreeWater/${SUBJECT}_choroid_plexus_FW_eroded.txt
