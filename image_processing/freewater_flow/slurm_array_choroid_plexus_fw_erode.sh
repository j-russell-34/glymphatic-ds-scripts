...
CONTAINER="/project2/jasonkru_1564/containers/fs7/fs7.sif"
...
apptainer exec \
    ...
    -B /scratch1/jasonkru/atri_code/processors/freewater_flow:/data/scripts \
    -B /home1/jasonkru/license/fs_license:/license \
    --env SUBJECTS_DIR="/data/subjects" \
    --env FS_LICENSE="/license/license.txt" \
    "$CONTAINER" \
    bash /data/scripts/choroid_plexus_fw_erode.sh ${SUBJECT_ID}