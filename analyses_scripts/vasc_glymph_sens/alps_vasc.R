...
out_dir <- glue("/Users/jasonkru/Documents/outputs/{STUDY}/alps_sens")
alps_dir <- glue("/Users/jasonkru/Documents/outputs/{STUDY}/alps")
...
b1000_only_scans <- read_csv(glue("{alps_dir}/b1000_subs.csv"))
